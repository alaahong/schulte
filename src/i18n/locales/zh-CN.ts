...
export const zhCN: Record<string, string> = {
  ...
  'settings.eyeCare': '护眼模式',
  'settings.eyeCareDesc': '暖色滤镜,降低蓝光,夜间训练更舒适',
  'settings.eyeCareBrightness': '亮度',
  'settings.eyeCareWarmth': '色温(暖度)',
  'settings.eyeCareBlueLight': '蓝光过滤',
  'settings.eyeCareReset': '恢复默认',
  'settings.eyeCarePreset.day': '白天',
  'settings.eyeCarePreset.dayDesc': '自然光,几乎无滤镜',
  'settings.eyeCarePreset.reading': '阅读',
  'settings.eyeCarePreset.readingDesc': '温和暖色,适度护眼',
  'settings.eyeCarePreset.night': '夜间',
  'settings.eyeCarePreset.nightDesc': '强暖色 + 强蓝光过滤',
  'settings.soundPack': '音效包',
  'settings.soundPackHint': '默认无声;biubiubiu / duangduangduang / gangganggang 等可选',
  'settings.effects': '视觉特效',
  'settings.effectsHint': '默认无;点击正确时的动画(抖动/弹出/粒子)',
  'settings.soundPack.none': '无声',
  'settings.soundPack.classic': '经典(beep)',
  'settings.soundPack.bubu': 'biubiubiu',
  'settings.soundPack.duang': 'duangduangduang',
  'settings.soundPack.gangan': 'gangganggang',
  'settings.soundPack.all': '全部轮换',
  'settings.effects.none': '无特效',
  'settings.effects.shake': '点击抖动',
  'settings.effects.pop': '缩放弹出',
  'settings.effects.burst': '粒子爆开',
  'settings.effects.all': '全部启用',
